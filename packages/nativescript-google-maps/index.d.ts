...
import { Point, KeyedTemplate } from "@nativescript/core/ui/core/view";
...
export class CameraUpdate {
    public ios: any; /* GMSCameraUpdate */
    public android: any;
    ...
    public static fitBoundsWithEdgeInsets(bounds: Bounds, padding: [number, number, number, number]): CameraUpdate;
...
export class MapView extends View {
    ...
    public animateCameraUpdate(update: CameraUpdate): void;
...
export class VisibleRegion {
    public ios: any; /* GMSVisibleRegion */
    public android: any;
